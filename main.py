...
# This entire section is correct and handles authentication robustly.
...
def handle_process_speech(SpeechResult: str = Form(...), CallSid: str = Form(...)):
    # ... (Logic for history, Gemini, and Supabase is correct) ...
    ...
    # Based on the latest documentation, the method is .tts.generate()
